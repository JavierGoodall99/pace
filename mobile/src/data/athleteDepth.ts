...
export const DEPTH: Record<number, AthleteDepth> = {
  ...
  9: {
    ...
    times: ['EARLY MORNING', 'WEEKENDS'],
    goalRaceId: null,
    pbs: [{ label: 'Midmar Mile', value: '24:10' }],
    prompts: [{ q: 'Best coffee stop', a: 'The kiosk at Clifton 4th, wet hair and all.' }],
    routes: [{ name: 'Clifton to Camps Bay', detail: 'Open water · 2 km' }],
    nearKm: 5,
    gender: 'woman',
    lifestyle: { drinks: 'social', diet: 'anything', restDay: 'adventure' },
    photosDaysAgo: 6,
  ...
  10: {
    ...
    times: ['EVENING', 'WEEKENDS'],
    goalRaceId: 'two-oceans-half',
    pbs: [{ label: '10 km', value: '56:30' }],
    prompts: [{ q: 'Slow down for…', a: 'Every dog on the promenade. Every single one.' }],
    routes: [{ name: 'Sea Point Promenade', detail: 'Easy 6 km · sunset' }],
    nearKm: 4,
    gender: 'woman',
    lifestyle: { drinks: 'social', diet: 'vegetarian', restDay: 'brunch' },
    photosDaysAgo: 20,
    womenFirst: false,
    motion: false,
    lastTrainedDays: 3,
