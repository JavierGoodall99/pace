...
export const ATHLETES: Athlete[] = demo<Athlete[]>(
  [
    {
      id: 1,
      slotId: 'athlete-1',
    ...
    },
    {
      ...
      pace: '1:45/100M',
      city: 'Cape Town',
      bio: 'Open-water swims at Clifton, then coffee on the rocks. Surf when it’s small.',
      weekly: 4,
      verified: true,
    },
    {
      ...
      pace: '5:20/KM',
      city: 'Cape Town',
      bio: 'Easy-paced runner, yoga on rest days. Training for my first half.',
      weekly: 3,
      verified: false,
    },
  ],
...
export const CHAT_THREADS: ChatThread[] = demo<ChatThread[]>(
  [
...
export const THREAD_MESSAGES: Record<number, ThreadMessage[]> = demo<
...
export const NOTIFICATIONS: AppNotification[] = demo<AppNotification[]>(
  [
    {
      id: 1,
      athleteId: 5,
